...
1. 정보 구조
    ...
    - **P.411**의 사이트 메뉴 구조도
1. 내비게이션
    - 사용자가 사이트에서 **원하는 정보를 찾도록 안내하는 것**이다.

## P.425 W3C

- World Wide Web Consortium, 웹 표준을 개발하고 장려함

## P.415 웹 접근성 지침

- KWCAG: 장애인이 비장애인과 동등하게 웹 컨텐츠에 접근할 수 있도록 웹 컨텐츠를 제작하는 방법에 관하여 기술한 것이다
